...
# from simplerl_math_eval.latex2sympy.latex2sympy2 import latex2sympy
# from simplerl_math_eval import latex2sympy
from simplerl_math_eval.latex2sympy.latex2sympy2 import latex2sympy
...
def _test_math_equal():
    ...
    # print(math_equal("(-\\frac{16}{5},\\frac{53}{10})", "\\left( -\\frac{16}{5}, \\frac{53}{10} \\right)"))
    print(symbolic_equal("(-\\frac{16}{5},\\frac{53}{10})", "\\left( -\\frac{16}{5}, \\frac{53}{10} \\right)"))
