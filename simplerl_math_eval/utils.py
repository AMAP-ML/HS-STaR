...
from simplerl_math_eval.examples import get_examples
from dart_math.utils import PROMPT_TEMPLATE_ID2DICT
...
PROMPT_TEMPLATES = {
    ...
    # "deepseek-math-step-cot-enter": (
    #     "<｜begin▁of▁sentence｜>User:\n{input}\nGiven a math problem, please reason step by step, separating each step with '\n\n', and put your final answer within \\boxed{{}}.\n\nAssistant:\n",
    #     "{output}",
    #     "\n\n"
    # ),
    "llama3-step-cot-enter-ins": (
...
PROMPT_TEMPLATES.update({
    prompt_type_add:(
        PROMPT_TEMPLATE_ID2DICT[prompt_type_add]['sys_prompt'] + \
            PROMPT_TEMPLATE_ID2DICT[prompt_type_add]['query_prompt'] + "{input}" +\
            PROMPT_TEMPLATE_ID2DICT[prompt_type_add]['prompt_after_query'] + \
            PROMPT_TEMPLATE_ID2DICT[prompt_type_add]['resp_prompt'],
        "{output}",
        "\n\n"
    )
    for prompt_type_add in [
        'llama3-step-cot-enter',
        'qwen25-step-cot-enter',
        'qwen25-step-cot',
        'qwen25-ins-cot',
        'deepseek-math-step-cot-enter',
        # 'qwen25-step-cot-enter-single',
        'qwen25-step-cot-space-zero',
        'eurus-prime-cot',
        'phi3-cot',
        'phi35-mini-ins-cot',
        'phi4-cot',
